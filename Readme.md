...
![Bounding box over 30 faces](Screenshot_2026-02-14_213838.png)

## Then We used two eatures namely the hue and saturation to plot all the faces into a 2D cartesian plane

![Faces on a 2D Plane](Screenshot_2026-02-14_213907.png)
![Faces represented as Dots](cluster_without_ST.png)

## Now we draw a bounding box over Dr. Shashi Tharoor's face. 

![Green Rectangle over face](Screenshot_2026-02-14_213848.png)

## Now, we use Kmeans clustering to predict in which class should Dr. Shashi Tharoor Belong to 

![Plot with Dr. ST's Face](faces_with_ST.png)
![Faces represented as Dots](Cluster_with_ST.png)
